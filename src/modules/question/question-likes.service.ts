...
export class QuestionLikesService {
    constructor(private readonly questionLikesRepository: QuestionLikesRepository) { }

    async getLike(questionId: string, userId: string) {
        return this.questionLikesRepository.findByQuestionAndUser(questionId, userId);
    }
